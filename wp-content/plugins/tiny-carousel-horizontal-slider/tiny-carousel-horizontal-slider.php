...
#tiny-carousel-slider1 .viewport { float: left; width: ".$tch_viewport."px; height: ".$tch_height."px; overflow: hidden; position: relative; width: 100% !important}
#tiny-carousel-slider1 .buttons { background:url('$buttonurl') no-repeat scroll 0 0 transparent; display: block; margin: ".$buttonsmargin."px 10px 0 0; background-position: 0 -38px; text-indent: -999em; float: left; width: 39px; height: 37px; overflow: hidden; position: relative; display: none}
